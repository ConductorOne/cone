...
type WorkflowExecutionSearch struct {
	sdkConfiguration sdkConfiguration
}

func newWorkflowExecutionSearch(sdkConfig sdkConfiguration) *WorkflowExecutionSearch {
	return &WorkflowExecutionSearch{
...
func (s *WorkflowExecutionSearch) SearchWorkflowExecutions(ctx context.Context, request *shared.SearchWorkflowExecutionsRequest, opts ...operations.Option) (*operations.C1APIWorkflowsV1betaWorkflowExecutionSearchServiceSearchWorkflowExecutionsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/api/v1beta/workflow_executions/search")
	if err != nil {
	...
	res := &operations.C1APIWorkflowsV1betaWorkflowExecutionSearchServiceSearchWorkflowExecutionsResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.SearchWorkflowExecutionsResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.SearchWorkflowExecutionsResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
