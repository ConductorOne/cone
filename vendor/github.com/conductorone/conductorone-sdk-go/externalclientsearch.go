...
type ExternalClientSearch struct {
	rootSDK          *ConductoroneAPI
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newExternalClientSearch(rootSDK *ConductoroneAPI, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *ExternalClientSearch {
	return &ExternalClientSearch{
		rootSDK:          rootSDK,
...
func (s *ExternalClientSearch) Search(ctx context.Context, request *shared.ExternalClientSearchServiceSearchRequest, opts ...operations.Option) (*operations.C1APIIamV1ExternalClientSearchServiceSearchResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/api/v1/search/iam/external_clients")
	if err != nil {
	...
	res := &operations.C1APIIamV1ExternalClientSearchServiceSearchResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.ExternalClientSearchServiceSearchResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ExternalClientSearchServiceSearchResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
