...
func (t TaskAuditListResponse) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(t, "", false)
}

func (t *TaskAuditListResponse) UnmarshalJSON(data []byte) error {
...
func (t *TaskAuditListResponse) GetTotalCount() *int64 {
	if t == nil {
		return nil
	}
	return t.TotalCount
