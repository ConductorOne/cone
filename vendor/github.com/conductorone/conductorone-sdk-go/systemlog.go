...
func newSystemLog(rootSDK *ConductoroneAPI, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *SystemLog {
	return &SystemLog{
		rootSDK:          rootSDK,
...
func (s *SystemLog) ListEvents(ctx context.Context, request *shared.SystemLogServiceListEventsRequest, opts ...operations.Option) (*operations.C1APISystemlogV1SystemLogServiceListEventsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/api/v1/systemlog/events")
	if err != nil {
