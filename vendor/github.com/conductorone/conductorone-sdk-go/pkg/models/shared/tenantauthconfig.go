...
// TenantAuthConfigProviderType - Provider type (read-only after creation — provider config determines type).
type TenantAuthConfigProviderType string

const (
	TenantAuthConfigProviderTypeAuthConfigProviderTypeUnspecified TenantAuthConfigProviderType = "AUTH_CONFIG_PROVIDER_TYPE_UNSPECIFIED"
	TenantAuthConfigProviderTypeAuthConfigProviderTypeGoogle      TenantAuthConfigProviderType = "AUTH_CONFIG_PROVIDER_TYPE_GOOGLE"
	TenantAuthConfigProviderTypeAuthConfigProviderTypeMicrosoft   TenantAuthConfigProviderType = "AUTH_CONFIG_PROVIDER_TYPE_MICROSOFT"
	TenantAuthConfigProviderTypeAuthConfigProviderTypeOkta        TenantAuthConfigProviderType = "AUTH_CONFIG_PROVIDER_TYPE_OKTA"
	TenantAuthConfigProviderTypeAuthConfigProviderTypeOnelogin    TenantAuthConfigProviderType = "AUTH_CONFIG_PROVIDER_TYPE_ONELOGIN"
	TenantAuthConfigProviderTypeAuthConfigProviderTypeJumpcloud   TenantAuthConfigProviderType = "AUTH_CONFIG_PROVIDER_TYPE_JUMPCLOUD"
	TenantAuthConfigProviderTypeAuthConfigProviderTypePingone     TenantAuthConfigProviderType = "AUTH_CONFIG_PROVIDER_TYPE_PINGONE"
	TenantAuthConfigProviderTypeAuthConfigProviderTypeOidc        TenantAuthConfigProviderType = "AUTH_CONFIG_PROVIDER_TYPE_OIDC"
	TenantAuthConfigProviderTypeAuthConfigProviderTypeC1Local     TenantAuthConfigProviderType = "AUTH_CONFIG_PROVIDER_TYPE_C1_LOCAL"
)

func (e TenantAuthConfigProviderType) ToPointer() *TenantAuthConfigProviderType {
	return &e
}

// IsExact returns true if the value matches a known enum value, false otherwise.
func (e *TenantAuthConfigProviderType) IsExact() bool {
	if e != nil {
		switch *e {
...
type TenantAuthConfig struct {
	...
	ProviderType *TenantAuthConfigProviderType `json:"providerType,omitempty"`
	// The status field.
...
func (t *TenantAuthConfig) GetProviderType() *TenantAuthConfigProviderType {
	if t == nil {
		return nil
	}
