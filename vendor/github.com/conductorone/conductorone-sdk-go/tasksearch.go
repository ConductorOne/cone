...
func newTaskSearch(rootSDK *ConductoroneAPI, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *TaskSearch {
	return &TaskSearch{
		rootSDK:          rootSDK,
...
func (s *TaskSearch) Search(ctx context.Context, request *shared.TaskSearchRequest, opts ...operations.Option) (*operations.C1APITaskV1TaskSearchServiceSearchResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/api/v1/search/tasks")
	if err != nil {
