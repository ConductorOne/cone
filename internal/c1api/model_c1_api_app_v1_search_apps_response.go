...
// checks if the C1ApiAppV1SearchAppsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &C1ApiAppV1SearchAppsResponse{}

// C1ApiAppV1SearchAppsResponse The SearchAppsResponse message.
type C1ApiAppV1SearchAppsResponse struct {
	// The list field.
...
type _C1ApiAppV1SearchAppsResponse C1ApiAppV1SearchAppsResponse
...
func NewC1ApiAppV1SearchAppsResponse() *C1ApiAppV1SearchAppsResponse {
	this := C1ApiAppV1SearchAppsResponse{}
	return &this
}
...
func (o C1ApiAppV1SearchAppsResponse) MarshalJSON() ([]byte, error) {
...
func (o C1ApiAppV1SearchAppsResponse) ToMap() (map[string]interface{}, error) {
...
func (o *C1ApiAppV1SearchAppsResponse) UnmarshalJSON(bytes []byte) (err error) {
	varC1ApiAppV1SearchAppsResponse := _C1ApiAppV1SearchAppsResponse{}

	if err = json.Unmarshal(bytes, &varC1ApiAppV1SearchAppsResponse); err == nil {
		*o = C1ApiAppV1SearchAppsResponse(varC1ApiAppV1SearchAppsResponse)
	}
...
type NullableC1ApiAppV1SearchAppsResponse struct {
	value *C1ApiAppV1SearchAppsResponse
	isSet bool
}

func (v NullableC1ApiAppV1SearchAppsResponse) Get() *C1ApiAppV1SearchAppsResponse {
	return v.value
}

func (v *NullableC1ApiAppV1SearchAppsResponse) Set(val *C1ApiAppV1SearchAppsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableC1ApiAppV1SearchAppsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableC1ApiAppV1SearchAppsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableC1ApiAppV1SearchAppsResponse(val *C1ApiAppV1SearchAppsResponse) *NullableC1ApiAppV1SearchAppsResponse {
	return &NullableC1ApiAppV1SearchAppsResponse{value: val, isSet: true}
}

func (v NullableC1ApiAppV1SearchAppsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableC1ApiAppV1SearchAppsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
