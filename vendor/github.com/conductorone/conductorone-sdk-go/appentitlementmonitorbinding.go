...
func newAppEntitlementMonitorBinding(rootSDK *ConductoroneAPI, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *AppEntitlementMonitorBinding {
	return &AppEntitlementMonitorBinding{
		rootSDK:          rootSDK,
...
func (s *AppEntitlementMonitorBinding) CreateAppEntitlementMonitorBinding(ctx context.Context, request *shared.CreateAppEntitlementMonitorBindingRequest, opts ...operations.Option) (*operations.C1APIAccessconflictV1AppEntitlementMonitorBindingServiceCreateAppEntitlementMonitorBindingResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/api/v1/appentitlementmonitorbinding")
	if err != nil {
	...
	res := &operations.C1APIAccessconflictV1AppEntitlementMonitorBindingServiceCreateAppEntitlementMonitorBindingResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.AppEntitlementMonitorBinding
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.AppEntitlementMonitorBinding = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *AppEntitlementMonitorBinding) DeleteAppEntitlementMonitorBinding(ctx context.Context, request *shared.DeleteAppEntitlementMonitorBindingRequest, opts ...operations.Option) (*operations.C1APIAccessconflictV1AppEntitlementMonitorBindingServiceDeleteAppEntitlementMonitorBindingResponse, error) {
	...
	res := &operations.C1APIAccessconflictV1AppEntitlementMonitorBindingServiceDeleteAppEntitlementMonitorBindingResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.DeleteAppEntitlementMonitorBindingResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.DeleteAppEntitlementMonitorBindingResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *AppEntitlementMonitorBinding) GetAppEntitlementMonitorBinding(ctx context.Context, request *shared.GetAppEntitlementMonitorBindingRequest, opts ...operations.Option) (*operations.C1APIAccessconflictV1AppEntitlementMonitorBindingServiceGetAppEntitlementMonitorBindingResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/api/v1/appentitlementmonitorbinding/get")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.C1APIAccessconflictV1AppEntitlementMonitorBindingServiceGetAppEntitlementMonitorBindingResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
