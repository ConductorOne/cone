...
func newConnectorCatalog(rootSDK *ConductoroneAPI, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *ConnectorCatalog {
...
func (s *ConnectorCatalog) ConfigurationSchema(ctx context.Context, request *shared.ConnectorCatalogServiceConfigurationSchemaRequest, opts ...operations.Option) (*operations.C1APIIntegrationConnectorV1ConnectorCatalogServiceConfigurationSchemaResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/api/v1/connectorcatalog")
	if err != nil {
	...
	res := &operations.C1APIIntegrationConnectorV1ConnectorCatalogServiceConfigurationSchemaResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.ConnectorCatalogServiceConfigurationSchemaResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ConnectorCatalogServiceConfigurationSchemaResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
