...
func (s *Connector) ConfirmSyncValid(ctx context.Context, request operations.C1APIAppV1ConnectorServiceConfirmSyncValidRequest, opts ...operations.Option) (*operations.C1APIAppV1ConnectorServiceConfirmSyncValidResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/api/v1/apps/{app_id}/connectors/{connector_id}/confirm_sync_valid/{sync_lifecycle_id}", request, nil)
	if err != nil {
	...
	res := &operations.C1APIAppV1ConnectorServiceConfirmSyncValidResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.ConfirmSyncValidResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ConfirmSyncValidResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Connector) GetConnectorSyncDownloadURL(ctx context.Context, request operations.C1APIAppV1ConnectorServiceGetConnectorSyncDownloadURLRequest, opts ...operations.Option) (*operations.C1APIAppV1ConnectorServiceGetConnectorSyncDownloadURLResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/api/v1/apps/{app_id}/connectors/{connector_id}/syncs/{sync_id}/download_url", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.C1APIAppV1ConnectorServiceGetConnectorSyncDownloadURLResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.GetConnectorSyncDownloadURLResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.GetConnectorSyncDownloadURLResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Connector) PauseSync(ctx context.Context, request operations.C1APIAppV1ConnectorServicePauseSyncRequest, opts ...operations.Option) (*operations.C1APIAppV1ConnectorServicePauseSyncResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/api/v1/apps/{app_id}/connectors/{connector_id}/pause", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.C1APIAppV1ConnectorServicePauseSyncResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.PauseSyncResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.PauseSyncResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Connector) ResumeSync(ctx context.Context, request operations.C1APIAppV1ConnectorServiceResumeSyncRequest, opts ...operations.Option) (*operations.C1APIAppV1ConnectorServiceResumeSyncResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/api/v1/apps/{app_id}/connectors/{connector_id}/resume", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.C1APIAppV1ConnectorServiceResumeSyncResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.ResumeSyncResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ResumeSyncResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Connector) ValidateHTTPConnectorConfig(ctx context.Context, request *shared.EditorValidateRequest, opts ...operations.Option) (*operations.C1APIAppV1ConnectorServiceValidateHTTPConnectorConfigResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/api/v1/apps/connectors/validate_config/http")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.C1APIAppV1ConnectorServiceValidateHTTPConnectorConfigResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
