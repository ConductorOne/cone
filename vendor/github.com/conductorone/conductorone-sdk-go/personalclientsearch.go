...
func newPersonalClientSearch(rootSDK *ConductoroneAPI, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *PersonalClientSearch {
	return &PersonalClientSearch{
		rootSDK:          rootSDK,
...
func (s *PersonalClientSearch) Search(ctx context.Context, request *shared.PersonalClientSearchServiceSearchRequest, opts ...operations.Option) (*operations.C1APIIamV1PersonalClientSearchServiceSearchResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/api/v1/search/iam/personal_clients")
	if err != nil {
	...
	res := &operations.C1APIIamV1PersonalClientSearchServiceSearchResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.PersonalClientSearchServiceSearchResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.PersonalClientSearchServiceSearchResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
