...
type C1Client interface {
	...
	GetResource(ctx context.Context, appID string, resourceID string, resourceTypeID string) (*C1ApiAppV1AppResource, error)
	GetResourceType(ctx context.Context, appID string, resourceTypeID string) (*C1ApiAppV1AppResourceType, error)
	GetApp(ctx context.Context, appID string) (*C1ApiAppV1App, error)
}
