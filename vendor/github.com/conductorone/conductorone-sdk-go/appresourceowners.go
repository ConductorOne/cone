...
func newAppResourceOwners(rootSDK *ConductoroneAPI, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *AppResourceOwners {
...
func (s *AppResourceOwners) Delete(ctx context.Context, request operations.C1APIAppV1AppResourceOwnersDeleteRequest, opts ...operations.Option) (*operations.C1APIAppV1AppResourceOwnersDeleteResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/api/v1/apps/{app_id}/resource_types/{resource_type_id}/resource/{resource_id}/ownerids", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.C1APIAppV1AppResourceOwnersDeleteResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.DeleteAppResourceOwnersResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.DeleteAppResourceOwnersResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *AppResourceOwners) ListOwnerIDs(ctx context.Context, request operations.C1APIAppV1AppResourceOwnersListOwnerIDsRequest, opts ...operations.Option) (*operations.C1APIAppV1AppResourceOwnersListOwnerIDsResponse, error) {
	...
	res := &operations.C1APIAppV1AppResourceOwnersListOwnerIDsResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.ListAppResourceOwnerIDsResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ListAppResourceOwnerIDsResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *AppResourceOwners) Set(ctx context.Context, request operations.C1APIAppV1AppResourceOwnersSetRequest, opts ...operations.Option) (*operations.C1APIAppV1AppResourceOwnersSetResponse, error) {
	...
	res := &operations.C1APIAppV1AppResourceOwnersSetResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.SetAppResourceOwnersResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.SetAppResourceOwnersResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
