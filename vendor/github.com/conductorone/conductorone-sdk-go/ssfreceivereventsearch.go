...
type SSFReceiverEventSearch struct {
	rootSDK          *ConductoroneAPI
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newSSFReceiverEventSearch(rootSDK *ConductoroneAPI, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *SSFReceiverEventSearch {
...
func (s *SSFReceiverEventSearch) Search(ctx context.Context, request *shared.SSFReceiverEventSearchServiceSearchRequest, opts ...operations.Option) (*operations.C1APISSFReceiverV1SSFReceiverEventSearchServiceSearchResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/api/v1/search/ssf-receiver-events")
	if err != nil {
	...
	res := &operations.C1APISSFReceiverV1SSFReceiverEventSearchServiceSearchResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.SSFReceiverEventSearchServiceSearchResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.SSFReceiverEventSearchServiceSearchResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
