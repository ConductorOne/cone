...
func newAppUser(rootSDK *ConductoroneAPI, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *AppUser {
	return &AppUser{
		rootSDK:          rootSDK,
...
// ListOwnedServiceAccounts - List Owned Service Accounts
...
func (s *AppUser) ListOwnedServiceAccounts(ctx context.Context, request *shared.ListOwnedServiceAccountsRequest, opts ...operations.Option) (*operations.C1APIAppV1AppUserServiceListOwnedServiceAccountsResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := url.JoinPath(baseURL, "/api/v1/app_users/owned_service_accounts")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "c1.api.app.v1.AppUserService.ListOwnedServiceAccounts",
		OAuth2Scopes:     nil,
		SecuritySource:   s.sdkConfiguration.Security,
	}
	...
	res := &operations.C1APIAppV1AppUserServiceListOwnedServiceAccountsResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.ListOwnedServiceAccountsResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ListOwnedServiceAccountsResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
