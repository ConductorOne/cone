...
// checks if the C1ApiTaskV1TaskActionsServiceCommentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &C1ApiTaskV1TaskActionsServiceCommentResponse{}
...
type _C1ApiTaskV1TaskActionsServiceCommentResponse C1ApiTaskV1TaskActionsServiceCommentResponse
...
func NewC1ApiTaskV1TaskActionsServiceCommentResponse() *C1ApiTaskV1TaskActionsServiceCommentResponse {
	this := C1ApiTaskV1TaskActionsServiceCommentResponse{}
	return &this
}
...
func (o C1ApiTaskV1TaskActionsServiceCommentResponse) MarshalJSON() ([]byte, error) {
...
func (o C1ApiTaskV1TaskActionsServiceCommentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *C1ApiTaskV1TaskActionsServiceCommentResponse) UnmarshalJSON(bytes []byte) (err error) {
	varC1ApiTaskV1TaskActionsServiceCommentResponse := _C1ApiTaskV1TaskActionsServiceCommentResponse{}

	if err = json.Unmarshal(bytes, &varC1ApiTaskV1TaskActionsServiceCommentResponse); err == nil {
		*o = C1ApiTaskV1TaskActionsServiceCommentResponse(varC1ApiTaskV1TaskActionsServiceCommentResponse)
	}
...
type NullableC1ApiTaskV1TaskActionsServiceCommentResponse struct {
	value *C1ApiTaskV1TaskActionsServiceCommentResponse
	isSet bool
}

func (v NullableC1ApiTaskV1TaskActionsServiceCommentResponse) Get() *C1ApiTaskV1TaskActionsServiceCommentResponse {
	return v.value
}

func (v *NullableC1ApiTaskV1TaskActionsServiceCommentResponse) Set(val *C1ApiTaskV1TaskActionsServiceCommentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableC1ApiTaskV1TaskActionsServiceCommentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableC1ApiTaskV1TaskActionsServiceCommentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableC1ApiTaskV1TaskActionsServiceCommentResponse(val *C1ApiTaskV1TaskActionsServiceCommentResponse) *NullableC1ApiTaskV1TaskActionsServiceCommentResponse {
	return &NullableC1ApiTaskV1TaskActionsServiceCommentResponse{value: val, isSet: true}
}

func (v NullableC1ApiTaskV1TaskActionsServiceCommentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableC1ApiTaskV1TaskActionsServiceCommentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
