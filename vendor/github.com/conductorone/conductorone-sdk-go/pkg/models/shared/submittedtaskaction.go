...
const (
	...
	ActionTypeTaskActionTypeRetryProvisioning                        ActionType = "TASK_ACTION_TYPE_RETRY_PROVISIONING"
)
...
// SubmittedTaskAction - Represents a single action that was performed on a task.
type SubmittedTaskAction struct {
...
func (s SubmittedTaskAction) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(s, "", false)
}

func (s *SubmittedTaskAction) UnmarshalJSON(data []byte) error {
...
func (s *SubmittedTaskAction) GetActionType() *ActionType {
	if s == nil {
		return nil
	}
	return s.ActionType
...
func (s *SubmittedTaskAction) GetBulkActionID() *string {
	if s == nil {
		return nil
	}
	return s.BulkActionID
}

func (s *SubmittedTaskAction) GetCreatedAt() *time.Time {
	if s == nil {
		return nil
	}
	return s.CreatedAt
...
func (s *SubmittedTaskAction) GetDeletedAt() *time.Time {
	if s == nil {
		return nil
	}
	return s.DeletedAt
...
func (s *SubmittedTaskAction) GetID() *string {
	if s == nil {
		return nil
	}
	return s.ID
...
func (s *SubmittedTaskAction) GetPolicyStepID() *string {
	if s == nil {
		return nil
	}
	return s.PolicyStepID
}

func (s *SubmittedTaskAction) GetUpdatedAt() *time.Time {
	if s == nil {
		return nil
	}
	return s.UpdatedAt
...
func (s *SubmittedTaskAction) GetUserID() *string {
	if s == nil {
		return nil
	}
	return s.UserID
