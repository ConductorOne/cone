...
func newPolicySearch(rootSDK *ConductoroneAPI, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *PolicySearch {
	return &PolicySearch{
		rootSDK:          rootSDK,
...
func (s *PolicySearch) Search(ctx context.Context, request *shared.SearchPoliciesRequest, opts ...operations.Option) (*operations.C1APIPolicyV1PolicySearchSearchResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/api/v1/search/policies")
	if err != nil {
