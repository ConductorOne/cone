...
func newExportsSearch(rootSDK *ConductoroneAPI, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *ExportsSearch {
	return &ExportsSearch{
		rootSDK:          rootSDK,
...
func (s *ExportsSearch) Search(ctx context.Context, request *shared.ExportsSearchServiceSearchRequest, opts ...operations.Option) (*operations.C1APISystemlogV1ExportsSearchServiceSearchResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/api/v1/search/systemlog/exports")
	if err != nil {
	...
	res := &operations.C1APISystemlogV1ExportsSearchServiceSearchResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.ExportsSearchServiceSearchResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ExportsSearchServiceSearchResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
