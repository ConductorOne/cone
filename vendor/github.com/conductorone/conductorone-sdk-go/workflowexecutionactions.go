...
type WorkflowExecutionActions struct {
	sdkConfiguration sdkConfiguration
}

func newWorkflowExecutionActions(sdkConfig sdkConfiguration) *WorkflowExecutionActions {
	return &WorkflowExecutionActions{
...
func (s *WorkflowExecutionActions) TerminateWorkflow(ctx context.Context, request operations.C1APIWorkflowsV1betaWorkflowExecutionActionsServiceTerminateWorkflowRequest, opts ...operations.Option) (*operations.C1APIWorkflowsV1betaWorkflowExecutionActionsServiceTerminateWorkflowResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/api/v1beta/workflow_executions/{id}/actions/terminate", request, nil)
	if err != nil {
	...
	res := &operations.C1APIWorkflowsV1betaWorkflowExecutionActionsServiceTerminateWorkflowResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.TerminateWorkflowResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.TerminateWorkflowResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
