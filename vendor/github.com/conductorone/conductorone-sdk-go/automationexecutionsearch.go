...
type AutomationExecutionSearch struct {
	rootSDK          *ConductoroneAPI
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newAutomationExecutionSearch(rootSDK *ConductoroneAPI, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *AutomationExecutionSearch {
	return &AutomationExecutionSearch{
		rootSDK:          rootSDK,
...
func (s *AutomationExecutionSearch) SearchAllAutomationExecutions(ctx context.Context, request *shared.SearchAllAutomationExecutionsRequest, opts ...operations.Option) (*operations.C1APIAutomationsV1AutomationExecutionSearchServiceSearchAllAutomationExecutionsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/api/v1/search/all_automation_executions")
	if err != nil {
	...
	res := &operations.C1APIAutomationsV1AutomationExecutionSearchServiceSearchAllAutomationExecutionsResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.SearchAllAutomationExecutionsResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.SearchAllAutomationExecutionsResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *AutomationExecutionSearch) SearchAutomationExecutions(ctx context.Context, request *shared.SearchAutomationExecutionsRequest, opts ...operations.Option) (*operations.C1APIAutomationsV1AutomationExecutionSearchServiceSearchAutomationExecutionsResponse, error) {
	...
	res := &operations.C1APIAutomationsV1AutomationExecutionSearchServiceSearchAutomationExecutionsResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.SearchAutomationExecutionsResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.SearchAutomationExecutionsResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
