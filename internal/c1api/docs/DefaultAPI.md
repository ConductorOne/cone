...
------------- | ------------- | -------------
[**C1ApiAppV1AppEntitlementUserBindingServiceGet**](DefaultAPI.md#C1ApiAppV1AppEntitlementUserBindingServiceGet) | **Get** /api/v1/grants/app/{app_id}/entitlement/{app_entitlement_id}/user/{app_user_id} | 
...
## C1ApiAppV1AppEntitlementUserBindingServiceGet

> C1ApiAppV1GetAppEntitlementUserBindingResponse C1ApiAppV1AppEntitlementUserBindingServiceGet(ctx, appId, appEntitlementId, appUserId).Execute()
...
func main() {
    ...
    resp, r, err := apiClient.DefaultAPI.C1ApiAppV1AppEntitlementUserBindingServiceGet(context.Background(), appId, appEntitlementId, appUserId).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `DefaultAPI.C1ApiAppV1AppEntitlementUserBindingServiceGet``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `C1ApiAppV1AppEntitlementUserBindingServiceGet`: C1ApiAppV1GetAppEntitlementUserBindingResponse
    fmt.Fprintf(os.Stdout, "Response from `DefaultAPI.C1ApiAppV1AppEntitlementUserBindingServiceGet`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiC1ApiAppV1AppEntitlementUserBindingServiceGetRequest struct via the builder pattern
...
[**C1ApiAppV1GetAppEntitlementUserBindingResponse**](C1ApiAppV1GetAppEntitlementUserBindingResponse.md)
