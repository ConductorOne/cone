...
type DefaultAPIC1ApiAppV1AppEntitlementUserBindingServiceGetRequest struct {
	ctx context.Context
...
func (r DefaultAPIC1ApiAppV1AppEntitlementUserBindingServiceGetRequest) Execute() (*C1ApiAppV1GetAppEntitlementUserBindingResponse, *http.Response, error) {
	return r.ApiService.C1ApiAppV1AppEntitlementUserBindingServiceGetExecute(r)
}

/*
C1ApiAppV1AppEntitlementUserBindingServiceGet Method for C1ApiAppV1AppEntitlementUserBindingServiceGet

Invokes the c1.api.app.v1.AppEntitlementUserBindingService.Get method.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param appId
 @param appEntitlementId
 @param appUserId
 @return DefaultAPIC1ApiAppV1AppEntitlementUserBindingServiceGetRequest
*/
func (a *DefaultAPIService) C1ApiAppV1AppEntitlementUserBindingServiceGet(ctx context.Context, appId string, appEntitlementId string, appUserId string) DefaultAPIC1ApiAppV1AppEntitlementUserBindingServiceGetRequest {
	return DefaultAPIC1ApiAppV1AppEntitlementUserBindingServiceGetRequest{
		ApiService: a,
		ctx: ctx,
		appId: appId,
...
//  @return C1ApiAppV1GetAppEntitlementUserBindingResponse
func (a *DefaultAPIService) C1ApiAppV1AppEntitlementUserBindingServiceGetExecute(r DefaultAPIC1ApiAppV1AppEntitlementUserBindingServiceGetRequest) (*C1ApiAppV1GetAppEntitlementUserBindingResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *C1ApiAppV1GetAppEntitlementUserBindingResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.C1ApiAppV1AppEntitlementUserBindingServiceGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/grants/app/{app_id}/entitlement/{app_entitlement_id}/user/{app_user_id}"
	...
	localVarPath = strings.Replace(localVarPath, "{"+"app_user_id"+"}", url.PathEscape(parameterValueToString(r.appUserId, "appUserId")), -1)
