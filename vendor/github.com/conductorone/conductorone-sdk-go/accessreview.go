...
func (s *AccessReview) List(ctx context.Context, request operations.C1APIAccessreviewV1AccessReviewServiceListRequest, opts ...operations.Option) (*operations.C1APIAccessreviewV1AccessReviewServiceListResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/api/v1/access_reviews")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.C1APIAccessreviewV1AccessReviewServiceListResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.AccessReviewServiceListResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.AccessReviewServiceListResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
