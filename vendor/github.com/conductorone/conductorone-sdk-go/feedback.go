...
func newFeedback(rootSDK *ConductoroneAPI, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Feedback {
	return &Feedback{
		rootSDK:          rootSDK,
...
func (s *Feedback) CreateFeedback(ctx context.Context, request *shared.CreateFeedbackRequest, opts ...operations.Option) (*operations.C1APIFeedbackV1FeedbackServiceCreateFeedbackResponse, error) {
	...
	res := &operations.C1APIFeedbackV1FeedbackServiceCreateFeedbackResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.CreateFeedbackResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.CreateFeedbackResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
