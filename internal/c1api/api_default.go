...
type DefaultAPIC1ApiAppV1AppEntitlementsGetRequest struct {
	ctx context.Context
	ApiService *DefaultAPIService
	appId string
	id string
...
func (r DefaultAPIC1ApiAppV1AppEntitlementsGetRequest) Execute() (*C1ApiAppV1GetAppEntitlementResponse, *http.Response, error) {
...
Invokes the c1.api.app.v1.AppEntitlements.Get method.
 ...
 @param appId
 @param id
 @return DefaultAPIC1ApiAppV1AppEntitlementsGetRequest
*/
func (a *DefaultAPIService) C1ApiAppV1AppEntitlementsGet(ctx context.Context, appId string, id string) DefaultAPIC1ApiAppV1AppEntitlementsGetRequest {
	return DefaultAPIC1ApiAppV1AppEntitlementsGetRequest{
		ApiService: a,
		ctx: ctx,
		appId: appId,
...
func (a *DefaultAPIService) C1ApiAppV1AppEntitlementsGetExecute(r DefaultAPIC1ApiAppV1AppEntitlementsGetRequest) (*C1ApiAppV1GetAppEntitlementResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.C1ApiAppV1AppEntitlementsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
