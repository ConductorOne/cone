...
func newOrgNotificationSettings(rootSDK *ConductoroneAPI, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *OrgNotificationSettings {
...
func (s *OrgNotificationSettings) Get(ctx context.Context, opts ...operations.Option) (*operations.C1APISettingsV1OrgNotificationSettingsServiceGetResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/api/v1/settings/notifications/org")
	if err != nil {
	...
	res := &operations.C1APISettingsV1OrgNotificationSettingsServiceGetResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.GetOrgNotificationSettingsResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.GetOrgNotificationSettingsResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *OrgNotificationSettings) Update(ctx context.Context, request *shared.UpdateOrgNotificationSettingsRequest, opts ...operations.Option) (*operations.C1APISettingsV1OrgNotificationSettingsServiceUpdateResponse, error) {
	...
	res := &operations.C1APISettingsV1OrgNotificationSettingsServiceUpdateResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.UpdateOrgNotificationSettingsResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.UpdateOrgNotificationSettingsResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
