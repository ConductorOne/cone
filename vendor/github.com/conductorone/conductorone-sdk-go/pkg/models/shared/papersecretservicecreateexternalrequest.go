...
type PaperSecretServiceCreateExternalRequest struct {
	...
	FileSize *int64 `integer:"string" json:"fileSize,omitempty"`
...
func (p PaperSecretServiceCreateExternalRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(p, "", false)
}

func (p *PaperSecretServiceCreateExternalRequest) UnmarshalJSON(data []byte) error {
...
func (p *PaperSecretServiceCreateExternalRequest) GetFileSize() *int64 {
	if p == nil {
		return nil
	}
	return p.FileSize
