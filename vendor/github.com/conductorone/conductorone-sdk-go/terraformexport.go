...
func newTerraformExport(rootSDK *ConductoroneAPI, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *TerraformExport {
...
//	provider_version).
func (s *TerraformExport) GetSchema(ctx context.Context, opts ...operations.Option) (*operations.C1APITerraformExportV1TerraformExportServiceGetSchemaResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/api/v1/terraform-export/schema")
	if err != nil {
	...
	res := &operations.C1APITerraformExportV1TerraformExportServiceGetSchemaResponse{
