...
func newTaskAudit(rootSDK *ConductoroneAPI, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *TaskAudit {
	return &TaskAudit{
		rootSDK:          rootSDK,
...
func (s *TaskAudit) List(ctx context.Context, request *shared.TaskAuditListRequest, opts ...operations.Option) (*operations.C1APITaskV1TaskAuditListResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/api/v1/task/audits")
	if err != nil {
	...
	res := &operations.C1APITaskV1TaskAuditListResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.TaskAuditListResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.TaskAuditListResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
