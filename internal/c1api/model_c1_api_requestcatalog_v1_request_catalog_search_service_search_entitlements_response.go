...
// checks if the C1ApiRequestcatalogV1RequestCatalogSearchServiceSearchEntitlementsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &C1ApiRequestcatalogV1RequestCatalogSearchServiceSearchEntitlementsResponse{}
...
type _C1ApiRequestcatalogV1RequestCatalogSearchServiceSearchEntitlementsResponse C1ApiRequestcatalogV1RequestCatalogSearchServiceSearchEntitlementsResponse
...
func NewC1ApiRequestcatalogV1RequestCatalogSearchServiceSearchEntitlementsResponse() *C1ApiRequestcatalogV1RequestCatalogSearchServiceSearchEntitlementsResponse {
	this := C1ApiRequestcatalogV1RequestCatalogSearchServiceSearchEntitlementsResponse{}
	return &this
}
...
func (o C1ApiRequestcatalogV1RequestCatalogSearchServiceSearchEntitlementsResponse) MarshalJSON() ([]byte, error) {
...
func (o C1ApiRequestcatalogV1RequestCatalogSearchServiceSearchEntitlementsResponse) ToMap() (map[string]interface{}, error) {
...
func (o *C1ApiRequestcatalogV1RequestCatalogSearchServiceSearchEntitlementsResponse) UnmarshalJSON(bytes []byte) (err error) {
	varC1ApiRequestcatalogV1RequestCatalogSearchServiceSearchEntitlementsResponse := _C1ApiRequestcatalogV1RequestCatalogSearchServiceSearchEntitlementsResponse{}

	if err = json.Unmarshal(bytes, &varC1ApiRequestcatalogV1RequestCatalogSearchServiceSearchEntitlementsResponse); err == nil {
		*o = C1ApiRequestcatalogV1RequestCatalogSearchServiceSearchEntitlementsResponse(varC1ApiRequestcatalogV1RequestCatalogSearchServiceSearchEntitlementsResponse)
	}
...
type NullableC1ApiRequestcatalogV1RequestCatalogSearchServiceSearchEntitlementsResponse struct {
	value *C1ApiRequestcatalogV1RequestCatalogSearchServiceSearchEntitlementsResponse
	isSet bool
}

func (v NullableC1ApiRequestcatalogV1RequestCatalogSearchServiceSearchEntitlementsResponse) Get() *C1ApiRequestcatalogV1RequestCatalogSearchServiceSearchEntitlementsResponse {
	return v.value
}

func (v *NullableC1ApiRequestcatalogV1RequestCatalogSearchServiceSearchEntitlementsResponse) Set(val *C1ApiRequestcatalogV1RequestCatalogSearchServiceSearchEntitlementsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableC1ApiRequestcatalogV1RequestCatalogSearchServiceSearchEntitlementsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableC1ApiRequestcatalogV1RequestCatalogSearchServiceSearchEntitlementsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableC1ApiRequestcatalogV1RequestCatalogSearchServiceSearchEntitlementsResponse(val *C1ApiRequestcatalogV1RequestCatalogSearchServiceSearchEntitlementsResponse) *NullableC1ApiRequestcatalogV1RequestCatalogSearchServiceSearchEntitlementsResponse {
	return &NullableC1ApiRequestcatalogV1RequestCatalogSearchServiceSearchEntitlementsResponse{value: val, isSet: true}
}

func (v NullableC1ApiRequestcatalogV1RequestCatalogSearchServiceSearchEntitlementsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableC1ApiRequestcatalogV1RequestCatalogSearchServiceSearchEntitlementsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
