...
func (a AppEntitlementOwnerEntitlement) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(a, "", false)
}

func (a *AppEntitlementOwnerEntitlement) UnmarshalJSON(data []byte) error {
...
func (a *AppEntitlementOwnerEntitlement) GetAppEntitlement() *AppEntitlement {
	if a == nil {
		return nil
	}
