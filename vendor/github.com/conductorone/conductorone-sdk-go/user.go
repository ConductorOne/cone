...
func (s *User) Introspect(ctx context.Context, request *shared.UserIntrospectRequest, opts ...operations.Option) (*operations.C1APIUserV1UserServiceIntrospectResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := url.JoinPath(baseURL, "/api/v1/users/introspect")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.C1APIUserV1UserServiceIntrospectResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.UserIntrospectResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.UserIntrospectResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *User) SetExpiringUserDelegationBindingByAdmin(ctx context.Context, request operations.C1APIUserV1UserServiceSetExpiringUserDelegationBindingByAdminRequest, opts ...operations.Option) (*operations.C1APIUserV1UserServiceSetExpiringUserDelegationBindingByAdminResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/api/v1/users/{user_id}/set-delegation-by-admin", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, true, "SetExpiringUserDelegationBindingByAdminRequest", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	res := &operations.C1APIUserV1UserServiceSetExpiringUserDelegationBindingByAdminResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.SetExpiringUserDelegationBindingByAdminResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.SetExpiringUserDelegationBindingByAdminResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
