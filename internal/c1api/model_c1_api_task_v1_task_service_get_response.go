...
// checks if the C1ApiTaskV1TaskServiceGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &C1ApiTaskV1TaskServiceGetResponse{}
...
type _C1ApiTaskV1TaskServiceGetResponse C1ApiTaskV1TaskServiceGetResponse
...
func NewC1ApiTaskV1TaskServiceGetResponse() *C1ApiTaskV1TaskServiceGetResponse {
	this := C1ApiTaskV1TaskServiceGetResponse{}
	return &this
}
...
func (o C1ApiTaskV1TaskServiceGetResponse) MarshalJSON() ([]byte, error) {
...
func (o C1ApiTaskV1TaskServiceGetResponse) ToMap() (map[string]interface{}, error) {
...
func (o *C1ApiTaskV1TaskServiceGetResponse) UnmarshalJSON(bytes []byte) (err error) {
	varC1ApiTaskV1TaskServiceGetResponse := _C1ApiTaskV1TaskServiceGetResponse{}

	if err = json.Unmarshal(bytes, &varC1ApiTaskV1TaskServiceGetResponse); err == nil {
		*o = C1ApiTaskV1TaskServiceGetResponse(varC1ApiTaskV1TaskServiceGetResponse)
	}
...
type NullableC1ApiTaskV1TaskServiceGetResponse struct {
	value *C1ApiTaskV1TaskServiceGetResponse
	isSet bool
}

func (v NullableC1ApiTaskV1TaskServiceGetResponse) Get() *C1ApiTaskV1TaskServiceGetResponse {
	return v.value
}

func (v *NullableC1ApiTaskV1TaskServiceGetResponse) Set(val *C1ApiTaskV1TaskServiceGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableC1ApiTaskV1TaskServiceGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableC1ApiTaskV1TaskServiceGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableC1ApiTaskV1TaskServiceGetResponse(val *C1ApiTaskV1TaskServiceGetResponse) *NullableC1ApiTaskV1TaskServiceGetResponse {
	return &NullableC1ApiTaskV1TaskServiceGetResponse{value: val, isSet: true}
}

func (v NullableC1ApiTaskV1TaskServiceGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableC1ApiTaskV1TaskServiceGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
