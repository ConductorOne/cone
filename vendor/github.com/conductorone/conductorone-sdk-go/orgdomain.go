...
func newOrgDomain(rootSDK *ConductoroneAPI, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *OrgDomain {
	return &OrgDomain{
		rootSDK:          rootSDK,
...
func (s *OrgDomain) List(ctx context.Context, request operations.C1APISettingsV1OrgDomainServiceListRequest, opts ...operations.Option) (*operations.C1APISettingsV1OrgDomainServiceListResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/api/v1/settings/domains")
	if err != nil {
	...
	res := &operations.C1APISettingsV1OrgDomainServiceListResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.ListOrgDomainsResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ListOrgDomainsResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *OrgDomain) Update(ctx context.Context, request *shared.UpdateOrgDomainRequest, opts ...operations.Option) (*operations.C1APISettingsV1OrgDomainServiceUpdateResponse, error) {
	...
	res := &operations.C1APISettingsV1OrgDomainServiceUpdateResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.UpdateOrgDomainResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.UpdateOrgDomainResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
