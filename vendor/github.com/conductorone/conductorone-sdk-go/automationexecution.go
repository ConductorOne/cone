...
func newAutomationExecution(rootSDK *ConductoroneAPI, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *AutomationExecution {
...
func (s *AutomationExecution) GetAutomationExecution(ctx context.Context, request operations.C1APIAutomationsV1AutomationExecutionServiceGetAutomationExecutionRequest, opts ...operations.Option) (*operations.C1APIAutomationsV1AutomationExecutionServiceGetAutomationExecutionResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/api/v1/automation_executions/{id}", request, nil)
	if err != nil {
	...
	res := &operations.C1APIAutomationsV1AutomationExecutionServiceGetAutomationExecutionResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.GetAutomationExecutionResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.GetAutomationExecutionResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *AutomationExecution) ListAutomationExecutions(ctx context.Context, opts ...operations.Option) (*operations.C1APIAutomationsV1AutomationExecutionServiceListAutomationExecutionsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/api/v1/automation_executions")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.C1APIAutomationsV1AutomationExecutionServiceListAutomationExecutionsResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.ListAutomationExecutionsResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ListAutomationExecutionsResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
