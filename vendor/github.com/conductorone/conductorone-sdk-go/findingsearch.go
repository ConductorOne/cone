...
func newFindingSearch(rootSDK *ConductoroneAPI, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *FindingSearch {
...
func (s *FindingSearch) Search(ctx context.Context, request *shared.FindingSearchRequest, opts ...operations.Option) (*operations.C1APIFindingV1FindingSearchServiceSearchResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/api/v1/findings/search")
	if err != nil {
	...
	res := &operations.C1APIFindingV1FindingSearchServiceSearchResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.FindingSearchResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.FindingSearchResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
