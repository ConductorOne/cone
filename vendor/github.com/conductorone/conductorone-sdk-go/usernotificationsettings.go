...
func newUserNotificationSettings(rootSDK *ConductoroneAPI, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *UserNotificationSettings {
...
func (s *UserNotificationSettings) Get(ctx context.Context, opts ...operations.Option) (*operations.C1APISettingsV1UserNotificationSettingsServiceGetResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/api/v1/settings/notifications/user")
	if err != nil {
	...
	res := &operations.C1APISettingsV1UserNotificationSettingsServiceGetResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.GetUserNotificationSettingsResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.GetUserNotificationSettingsResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *UserNotificationSettings) Update(ctx context.Context, request *shared.UpdateUserNotificationSettingsRequest, opts ...operations.Option) (*operations.C1APISettingsV1UserNotificationSettingsServiceUpdateResponse, error) {
	...
	res := &operations.C1APISettingsV1UserNotificationSettingsServiceUpdateResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.UpdateUserNotificationSettingsResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.UpdateUserNotificationSettingsResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
