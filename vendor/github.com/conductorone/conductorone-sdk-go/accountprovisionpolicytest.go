...
type AccountProvisionPolicyTest struct {
	rootSDK          *ConductoroneAPI
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newAccountProvisionPolicyTest(rootSDK *ConductoroneAPI, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *AccountProvisionPolicyTest {
	return &AccountProvisionPolicyTest{
		rootSDK:          rootSDK,
...
func (s *AccountProvisionPolicyTest) Test(ctx context.Context, request *shared.TestAccountProvisionPolicyRequest, opts ...operations.Option) (*operations.C1APIPolicyV1AccountProvisionPolicyTestTestResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/api/v1/policies/test-account-provision-policy")
	if err != nil {
	...
	res := &operations.C1APIPolicyV1AccountProvisionPolicyTestTestResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.TestAccountProvisionPolicyResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.TestAccountProvisionPolicyResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
