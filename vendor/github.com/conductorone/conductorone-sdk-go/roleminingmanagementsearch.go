...
type RoleMiningManagementSearch struct {
	rootSDK          *ConductoroneAPI
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newRoleMiningManagementSearch(rootSDK *ConductoroneAPI, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *RoleMiningManagementSearch {
	return &RoleMiningManagementSearch{
		rootSDK:          rootSDK,
...
func (s *RoleMiningManagementSearch) Search(ctx context.Context, request *shared.RoleMiningSearchSuggestionsRequest, opts ...operations.Option) (*operations.C1APIRoleMiningManagementV1RoleMiningManagementSearchServiceSearchResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/api/v1/search/role-mining/suggestions")
	if err != nil {
	...
	res := &operations.C1APIRoleMiningManagementV1RoleMiningManagementSearchServiceSearchResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.RoleMiningSearchSuggestionsResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.RoleMiningSearchSuggestionsResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
